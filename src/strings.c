...
const u8 gText_ThisIsAPokemon[] = _("זה מה שאנחנו מכנים פוקימון.{PAUSE 96}\p");
...
const u8 gText_BoxName[] = _("שם קופסה?");
