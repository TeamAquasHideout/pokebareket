...
// Easy Chat keyboard
const u8 gText_EasyChatKeyboard_ABCDEFothers[] = _("ABCDEFothers");
const u8 gText_EasyChatKeyboard_GHIJKL[] = _("GHIJKL");
const u8 gText_EasyChatKeyboard_MNOPQRS[] = _("MNOPQRS");
const u8 gText_EasyChatKeyboard_TUVWXYZ[] = _("TUVWXYZ");

// Naming Screen keyboard
const u8 gText_NamingScreenKeyboard_abcdef[] = _("{CLEAR 6}.   {CLEAR 6}{CLEAR 6}{CLEAR 6}{CLEAR 6}{CLEAR 6}ו{CLEAR 6}ה{CLEAR 6}ד {CLEAR 6}{CLEAR 6}{CLEAR 6}{CLEAR 6}ג{CLEAR 6}ב{CLEAR 6}א");
const u8 gText_NamingScreenKeyboard_ghijkl[] = _("{CLEAR 6},   {CLEAR 6}{CLEAR 6}{CLEAR 6}{CLEAR 6}{CLEAR 6}ל{CLEAR 6}כ{CLEAR 6}ע {CLEAR 6}{CLEAR 6}{CLEAR 6}{CLEAR 6}ט{CLEAR 6}ח{CLEAR 6}ז");
const u8 gText_NamingScreenKeyboard_mnopqrs[] = _("{CLEAR 6}{CLEAR 6}{CLEAR 6}{CLEAR 6}{CLEAR 6}{CLEAR 6}ק{CLEAR 6}צ{CLEAR 6}פ{CLEAR 6}ע {CLEAR 6}{CLEAR 6}{CLEAR 6}{CLEAR 6}ס{CLEAR 6}נ{CLEAR 6}מ ");
const u8 gText_NamingScreenKeyboard_tuvwxyz[] = _("{CLEAR 6}{CLEAR 6}{CLEAR 6}{CLEAR 6}ץ{CLEAR 6}ף{CLEAR 6}ן{CLEAR 6}ם{CLEAR 6}ך {CLEAR 6}{CLEAR 6}{CLEAR 6}{CLEAR 6}ת{CLEAR 6}ש{CLEAR 6}ר ");
const u8 gText_NamingScreenKeyboard_ABCDEF[] = _("{CLEAR 6}.   {CLEAR 6}{CLEAR 6}{CLEAR 6}{CLEAR 6}{CLEAR 6}F{CLEAR 6}E{CLEAR 6}D {CLEAR 6}{CLEAR 6}{CLEAR 6}{CLEAR 6}C{CLEAR 6}B{CLEAR 6}A");
const u8 gText_NamingScreenKeyboard_GHIJKL[] = _("{CLEAR 6},   {CLEAR 6}{CLEAR 6}{CLEAR 6}{CLEAR 6}{CLEAR 6}L{CLEAR 6}K{CLEAR 6}J {CLEAR 6}{CLEAR 6}{CLEAR 6}{CLEAR 6}I{CLEAR 6}H{CLEAR 6}G");
const u8 gText_NamingScreenKeyboard_MNOPQRS[] = _("{CLEAR 6}{CLEAR 6}{CLEAR 6}{CLEAR 6}{CLEAR 6}{CLEAR 6}S{CLEAR 6}R{CLEAR 6}Q{CLEAR 6}P {CLEAR 6}{CLEAR 6}{CLEAR 6}{CLEAR 6}O{CLEAR 6}N{CLEAR 6}M ");
const u8 gText_NamingScreenKeyboard_TUVWXYZ[] = _("{CLEAR 6}{CLEAR 6}{CLEAR 6}{CLEAR 6}{CLEAR 6}{CLEAR 6}Z{CLEAR 6}Y{CLEAR 6}X{CLEAR 6}W {CLEAR 6}{CLEAR 6}{CLEAR 6}{CLEAR 6}V{CLEAR 6}U{CLEAR 6}T ");
const u8 gText_NamingScreenKeyboard_01234[] = _("0{CLEAR 16}1{CLEAR 16}2{CLEAR 16}3{CLEAR 16}4{CLEAR 16} ");
const u8 gText_NamingScreenKeyboard_56789[] = _("5{CLEAR 16}6{CLEAR 16}7{CLEAR 16}8{CLEAR 16}9{CLEAR 16} ");
const u8 gText_NamingScreenKeyboard_Symbols1[] = _("{CLEAR 12}!{CLEAR 17}?{CLEAR 16}♂{CLEAR 16}♀{CLEAR 16}/{CLEAR 17}-");
const u8 gText_NamingScreenKeyboard_Symbols2[] = _("…{CLEAR 16}“{CLEAR 16}”{CLEAR 18}‘{CLEAR 19}'{CLEAR 18} ");
