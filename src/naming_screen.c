...
static void DrawNormalTextEntryBox(void)
{
    ...
    AddTextPrinterParameterized(sNamingScreen->windows[WIN_TEXT_ENTRY_BOX], FONT_NORMAL, sNamingScreen->template->title, 100, 1, 0, 0);
...
static void DrawTextEntry(void)
{
    ...
    for (i = 0; i < maxChars; i++)
    {
        ...
        //letters in the lines of name selection
        AddTextPrinterParameterized(sNamingScreen->windows[WIN_TEXT_ENTRY], FONT_NORMAL, temp, 116 - i * 8 - x - extraWidth, 1, TEXT_SKIP_DRAW, NULL);
    }
